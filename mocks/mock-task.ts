...
export const mockTasks: Task[] = [
  {
    ...
    nextExecutedAt: new Date(new Date("2025-03-10T10:00:00Z").getTime() + (Math.floor(Math.random() * 7) + 1) * 24 * 60 * 60 * 1000),
    status: "active",
    emailsDeleted: 150,
    successCounts: 5,
    errorCounts: 1,
  ...
  },
  {
    ...
    nextExecutedAt: new Date(new Date("2025-02-15T14:30:00Z").getTime() + (Math.floor(Math.random() * 7) + 1) * 24 * 60 * 60 * 1000),
    status: "completed",
    emailsDeleted: 2500,
    successCounts: 25,
    errorCounts: 0,
  ...
  },
  {
    ...
    nextExecutedAt: new Date(new Date("2025-03-01T09:15:00Z").getTime() + (Math.floor(Math.random() * 7) + 1) * 24 * 60 * 60 * 1000),
    status: "paused",
    emailsDeleted: 50,
    successCounts: 2,
    errorCounts: 3,
  ...
  },
  {
    ...
    nextExecutedAt: new Date(new Date("2025-01-20T16:45:00Z").getTime() + (Math.floor(Math.random() * 7) + 1) * 24 * 60 * 60 * 1000),
    status: "active",
    emailsDeleted: 0,
    successCounts: 0,
    errorCounts: 0,
  ...
  },
  {
    ...
    nextExecutedAt: new Date(new Date("2025-03-25T08:30:00Z").getTime() + (Math.floor(Math.random() * 7) + 1) * 24 * 60 * 60 * 1000),
    status: "completed",
    emailsDeleted: 1230,
    successCounts: 10,
    errorCounts: 2,
  ...
  },
  {
    ...
    nextExecutedAt: new Date(new Date("2025-02-28T17:00:00Z").getTime() + (Math.floor(Math.random() * 7) + 1) * 24 * 60 * 60 * 1000),
    status: "active",
    emailsDeleted: 75,
    successCounts: 3,
    errorCounts: 0,
  ...
  },
  {
    ...
    nextExecutedAt: new Date(new Date("2025-03-15T11:20:00Z").getTime() + (Math.floor(Math.random() * 7) + 1) * 24 * 60 * 60 * 1000),
    status: "paused",
    emailsDeleted: 5,
    successCounts: 1,
    errorCounts: 1,
  ...
  },
  {
    ...
    nextExecutedAt: new Date(new Date("2025-01-05T13:40:00Z").getTime() + (Math.floor(Math.random() * 7) + 1) * 24 * 60 * 60 * 1000),
    status: "active",
    emailsDeleted: 420,
    successCounts: 12,
    errorCounts: 5,
  ...
  },
  {
    ...
    nextExecutedAt: new Date(new Date("2025-02-20T10:10:00Z").getTime() + (Math.floor(Math.random() * 7) + 1) * 24 * 60 * 60 * 1000),
    status: "completed",
    emailsDeleted: 300,
    successCounts: 30,
    errorCounts: 0,
  ...
  },
  {
    ...
    nextExecutedAt: new Date(new Date("2025-03-30T09:00:00Z").getTime() + (Math.floor(Math.random() * 7) + 1) * 24 * 60 * 60 * 1000),
    status: "active",
    emailsDeleted: 99,
    successCounts: 9,
    errorCounts: 0,
  ...
  },
  {
    ...
    nextExecutedAt: new Date(new Date("2025-02-05T15:45:00Z").getTime() + (Math.floor(Math.random() * 7) + 1) * 24 * 60 * 60 * 1000),
    status: "paused",
    emailsDeleted: 10,
    successCounts: 0,
    errorCounts: 2,
  ...
  },
  {
    ...
    nextExecutedAt: new Date(new Date("2025-03-12T11:30:00Z").getTime() + (Math.floor(Math.random() * 7) + 1) * 24 * 60 * 60 * 1000),
    status: "active",
    emailsDeleted: 600,
    successCounts: 60,
    errorCounts: 3,
  ...
  },
  {
    ...
    nextExecutedAt: new Date(new Date("2025-03-20T14:15:00Z").getTime() + (Math.floor(Math.random() * 7) + 1) * 24 * 60 * 60 * 1000),
    status: "completed",
    emailsDeleted: 1500,
    successCounts: 150,
    errorCounts: 0,
  ...
  },
  {
    ...
    nextExecutedAt: new Date(new Date("2025-01-15T17:00:00Z").getTime() + (Math.floor(Math.random() * 7) + 1) * 24 * 60 * 60 * 1000),
    status: "active",
    emailsDeleted: 80,
    successCounts: 4,
    errorCounts: 1,
  ...
  },
  {
    ...
    nextExecutedAt: new Date(new Date("2025-03-08T12:00:00Z").getTime() + (Math.floor(Math.random() * 7) + 1) * 24 * 60 * 60 * 1000),
    status: "paused",
    emailsDeleted: 22,
    successCounts: 2,
    errorCounts: 0,
  ...
  },
  {
    ...
    nextExecutedAt: new Date(new Date("2025-02-25T08:20:00Z").getTime() + (Math.floor(Math.random() * 7) + 1) * 24 * 60 * 60 * 1000),
    status: "active",
    emailsDeleted: 1000,
    successCounts: 100,
    errorCounts: 10,
  ...
  },
  {
    ...
    nextExecutedAt: new Date(new Date("2025-03-28T16:35:00Z").getTime() + (Math.floor(Math.random() * 7) + 1) * 24 * 60 * 60 * 1000),
    status: "completed",
    emailsDeleted: 550,
    successCounts: 55,
    errorCounts: 0,
  ...
  },
  {
    ...
    nextExecutedAt: new Date(new Date("2025-03-01T10:00:00Z").getTime() + (Math.floor(Math.random() * 7) + 1) * 24 * 60 * 60 * 1000),
    status: "active",
    emailsDeleted: 30,
    successCounts: 3,
    errorCounts: 0,
